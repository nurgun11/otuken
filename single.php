...
<div class="container">
    <a href="<?php echo get_post_type_archive_link('post'); ?>" class="back-button">
        <i class="fas fa-arrow-left"></i> <?php echo __('Вернуться к списку новостей', 'otuken'); ?>
    </a>
    ...
    <div class="news-content">
        ...
        <div class="news-share">
            <button class="share-button" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>', '_blank')">
                <i class="fab fa-facebook-f"></i> <?php echo __('Поделиться', 'otuken'); ?>
            </button>
...
<div class="news-related">
    <div class="container">
        <h2 class="related-title"><?php echo __('Похожие новости', 'otuken'); ?></h2>
        <div class="related-grid">
            ...
            <div class="related-card">
                ...
                <div class="related-content">
                    ...
                    <a href="<?php the_permalink(); ?>" class="related-link"><?php echo __('Подробнее', 'otuken'); ?></a>
                </div>
            </div>
            <?php
                }
                ...
                echo '<p>' . __('Похожих новостей не найдено.', 'otuken') . '</p>';
            }
            ?>
        </div>
    </div>
